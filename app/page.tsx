    ...
    <div className="w-full flex flex-col items-center">
      <header className='w-full'>
        <nav className="flex justify-center border-b">
          <div className=" w-full max-w-md flex justify-end items-center p-2 text-sm">
      ...
      <main className="w-full max-w-mw animate-in flex flex-col p-2">
          {
            user ? (
              <div>Logged</div>
            ) : (
